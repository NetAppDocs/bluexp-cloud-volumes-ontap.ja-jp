...
IMPORTANT: NetAppでは、まもなくノードベースライセンスの提供を終了します。販売終了後は、ノードベースのライセンスを容量ベースのライセンスに変換する必要があります。詳細については、を参照して https://mysupport.netapp.com/info/communications/CPC-00589.html["お客様とのコミュニケーション：CPC-00589"^]ください。
