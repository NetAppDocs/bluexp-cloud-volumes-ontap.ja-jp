...
NOTE: ストレージとネットワークの使用量は、2進数のギガバイト（GB）で計算されます。1GBは2^30バイトです。この単位は、ギビバイト（GiB）とも呼ばれます。同様に、1TBは2^40バイト、つまり1024GBです。
...
* Azureの場合：e4s_v3、e4ds_v4、ds4_v2、ds13_v2、e8s_v3、 E8ds_v4、E4ds_v5、およびE8ds_v5
