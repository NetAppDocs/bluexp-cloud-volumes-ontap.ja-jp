...
TIP: コネクタに関する情報をお探しですか？ https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-ports-azure.html["コネクタのセキュリティグループルールを表示します"^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["コネクタのネットワーク要件を確認します"^]
