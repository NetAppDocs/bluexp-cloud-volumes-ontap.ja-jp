...
NOTE: Flash Cache_、高速の書き込み速度、およびより高いMaximum Transmission Unit（MTU；最大伝送ユニット）8、896は、インスタンスタイプn2-standard-16、n2-standard-32、n2-standard-48、n2-standard-64で* High * write speedオプションを使用して使用できます。さらに、MTUが8、896の場合は、導入用にVCP-1、VPC-2、またはVCP-3を選択する必要があります。Flash Cache_、高速の書き込み速度、MTU 8、896は機能に依存し、設定したインスタンス内で個別に無効にすることはできません。
