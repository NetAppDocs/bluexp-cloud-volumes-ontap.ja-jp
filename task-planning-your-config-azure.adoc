...
Cloud Volumes ONTAP は、ほとんどの Microsoft Azure リージョンでサポートされています。 https://["サポートされているリージョンの完全なリストを表示します"^]。
...
https://["Azure で Cloud Volumes ONTAP がサポートされている構成"^]
...
https://["Azure での Cloud Volumes ONTAP のストレージの制限"^]
...
これらのディスクのユースケースの詳細については、を参照してください https://["Microsoft Azure のドキュメント：「 What disk types are available in Azure ？」"^]。
